...
# `Simple_tvtk_cone.py) <![](files/MayaVi(2f)tvtk_attachments/Simple_tvtk_cone.py>`_

quadrics
````````

A more interesting example is the generation of some contour surfaces of an implicit function.
# `Vis_quad.py) <![](files/MayaVi(2f)tvtk_attachments/Vis_quad.py>`_

This displays the following scene on screen and also saves it to a file.

.. image:: ![](files/MayaVi(2f)tvtk_attachments/vis_quad.png
)
...
.. image:: ![](files/MayaVi(2f)tvtk_attachments/ivtk_example.png
)
