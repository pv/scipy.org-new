...
# format) - <![](files/LinearClassification_attachments/bezdekIris.data.txt>
)# 
# <codecell>
...
# <![](files/LinearClassification_attachments/Fisher_disrciminant.JPG>
)# 
...
# 150 instances
# 
# <![](files/LinearClassification_attachments/Probabilistic_model.PNG>
)# 
