...
# `POINTER(POINTER(ctype))`](http://aspn.activestate.com/ASPN/Mail/Message/ctypes-users/3119087)\
# `* `[`Adding` `ctypes` `support` `to`
# `NumPy`](http://aspn.activestate.com/ASPN/Mail/Message/ctypes-users/3118513)\
# `* `[`Determining` `if` `a` `ctype` `is` `a` `pointer` `type` `(was`
# `RE:` `Adding` `ctypes` `support` `to`
# `NumPy)`](http://aspn.activestate.com/ASPN/Mail/Message/ctypes-users/3118656)\
# `* `[`Check` `for` `NULL` `pointer` `without`
# `ValueError`](http://aspn.activestate.com/ASPN/Mail/Message/ctypes-users/3117306)\
# `* `[`Problem` `with` `callbacks` `from` `C` `into`
# `Python`](http://aspn.activestate.com/ASPN/Mail/Message/ctypes-users/3205951)\
# `* [`[`http://thread.gmane.org/gmane.comp.python.numeric.general/7418`](http://thread.gmane.org/gmane.comp.python.numeric.general/7418)`\ ctypes and ndpointer]`\
# `* `[`Problems` `with` `64` `signed`
# `integer`](http://thread.gmane.org/gmane.comp.python.ctypes/3116)
# 
...
# `* `[`ctypes`
# `tutorial`](http://starship.python.net/crew/theller/ctypes/tutorial.html)\
# `* `[`13.14` `ctypes` `--` `A` `foreign` `function` `library` `for`
# `Python.`](http://docs.python.org/dev/lib/module-ctypes.html)
# 
# * * * * *
# 
