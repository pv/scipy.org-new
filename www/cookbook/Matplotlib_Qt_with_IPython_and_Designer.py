...
# 
# ![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/designer_newopen.png
# 
# When the wizard appears, remove all of the menus and toolbars that it
# suggests to generate:
# 
# ![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/designer_wizard.png
# 
# Now add a custom widget to your project as:
# 
# ![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/designer_edit_custom_widgets.png
# 
# Give this new widget the name of and set the size to 400, 300:
# 
# ![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/designer_new_widget.png
# 
...
# 
# ![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/designer_full_workspace.png
# 
# Now we need to get the "import" setting put in, as specified
# [here](http://www.river-bank.demon.co.uk/docs/pyqt/PyQt.html#AEN95):
# 
# ![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/designer_form_settings_comment.png
# 
# Of course, you'll also need the file that will then be included:
# <![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/mplwidget.py>.
)# 
...
# with what [I got](![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/mplwidget_tutorial.py). You can also look
)# at my <![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/mplwidget_tutorial.ui>
)# 
# Now, it's nice to have the invocation written up in its own
# <![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/main_mpl_tutorial.py> file, which is amazingly short:
)# 
# <codecell>
...
# it.
# 
# ![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/ipython_invoked.png
# 
...
# 
# ![](files/Matplotlib(2f)Qt_with_IPython_and_Designer_attachments/ipython_interacted.png
# 
