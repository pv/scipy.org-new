...
# 
# 1.  1.  pyrex should pass through python parser:
# 
# 
# 
# <codecell>
...
# [\_cam\_iface\_shm.pyx](http://code.astraw.com/projects/motmot/browser/trunk/cam_iface/src/_cam_iface_shm.pyx)
# in the [motmot camera utilities](http://code.astraw.com/projects/motmot)
# software. In this use example, an image is copied from shared memory
# into an externally malloced buffer supporting the interface. (The shared
# memory stuff has only been tested on linux, but the rest should work
# anywhere.)
# 
# See also
# ========
