...
# below.
# 
# ![](files/Matplotlib(2f)Plotting_Images_with_Special_Values_attachments/sentinel_pristine.png
# 
# ![](files/Matplotlib(2f)Plotting_Images_with_Special_Values_attachments/sentinel.png
# 
# * * * * *
# 
