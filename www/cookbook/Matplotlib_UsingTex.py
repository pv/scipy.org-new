...
# <![](files/Matplotlib(2f)UsingTex_attachments/tex_demo.png>
)# 
# Note that when TeX/LaTeX support is enabled, you can mix text and math
# modes. Display math mode (\$\$ e=mc\^2 \$\$) is not supported, but
# adding the command \\displaystyle, as in tex\_demo.py, will produce the
# same results.
# 
...
# [xpdf](http://www.foolabs.com/xpdf/download.html) or
# [poppler](http://poppler.freedesktop.org/) (the new backend to xpdf) can
# be activated by changing the rc ps.usedistiller setting to xpdf. The
