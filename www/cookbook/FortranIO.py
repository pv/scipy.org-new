...
# file](http://www.atnf.csiro.au/research/pulsar/tempo/ref_man_sections/output.txt)
# output by [TEMPO](http://www.atnf.csiro.au/research/pulsar/tempo/). Most
# of the fields, "TOA" up to "preres\_s", are fields that are present and
# of interest in the file. The field "pad3" is either an undocumented
