...
# SVN
# repository](http://svn.python.org/projects/python/branches/release24-maint/Misc/valgrind-python.supp).
# See also
# [README.valgrind](http://svn.python.org/projects/python/branches/release24-maint/Misc/README.valgrind)
...
# `Manual`](http://docs.python.org/api/api.html)` (then browse through this)`\
# `* Chapter 13 of `[`Guide` `to`
# `NumPy`](http://www.tramy.us/)` describes the complete API`\
...
# `numpy`](http://thread.gmane.org/gmane.comp.python.scientific.user/7392/focus=7400)\
# `* `[`newbie` `for` `writing` `numpy/scipy`
# `extensions`](http://thread.gmane.org/gmane.comp.python.numeric.general/5186/focus=5186)\
# `* `[`Array` `data` `and` `struct`
# `alignment`](http://thread.gmane.org/gmane.comp.python.numeric.general/5234/focus=5234)
# 
# * * * * *
# 
# CategoryCookbook
