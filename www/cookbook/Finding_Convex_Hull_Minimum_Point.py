...
# `2. `[`A` `recursive` `algorithm` `for` `finding` `the` `minimum` `norm`
# `point` `in` `a` `polytope` `and` `a` `pair` `of` `closest` `points`
# `in` `two`
# `polytopes`](http://www.springerlink.com/content/j25702174115q68x/)
# 
