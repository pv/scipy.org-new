...
# [Schrodinger_FDTD.pdf](![](files/SchrodingerFDTD_attachments/Schrodinger%5FFDTD%5Fnew.pdf)
)# 
# Examples
# --------
# 
...
# 
# <![](files/SchrodingerFDTD_attachments/schrod_step_init_sm2.png>
)# 
# And at the end of the simulation it can look like this, depending on the
# actual potential height:
# 
# <![](files/SchrodingerFDTD_attachments/schrod_step_lo_sm2.png> <![](files/SchrodingerFDTD_attachments/schrod_step_hi_sm2.png>
)# 
...
# barrier:
# 
# <![](files/SchrodingerFDTD_attachments/schrod_barrier_lo_sm2.png>
)# <![](files/SchrodingerFDTD_attachments/schrod_barrier_hi_sm2.png>
)# 
# Code
# ----
# 
