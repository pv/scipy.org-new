...
# [:TraitsUI:here]. Although ETS comes with it's own traits-aware plotting
...
# dragged, keeping the UI from lagging.[Here's](![](files/EmbeddingInTraitsGUI_attachments/mpl_editor.py)
)# the full listing:
# 
# <codecell>
