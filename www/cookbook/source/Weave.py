...
# [iterators_example.py](![](files/Weave_attachments/iterators_example.py) and
)# [iterators.py](![](files/Weave_attachments/iterators.py).
)# 
...
# This code is available in [fftmod.tar.gz](![](files/Weave_attachments/fftmod.tar.gz).
)# 
# * * * * *
# 
# CategoryCookbook
