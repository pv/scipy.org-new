...
# [ols.py](![](files/OLS_attachments/ols.0.2.py) file and run it (python ols.py). This
...
# 
# Library function
# [numpy.linalg.lstsq()](http://docs.scipy.org/doc/numpy/reference/generated/numpy.linalg.lstsq.html)
