...
# output](![](files/Matplotlib(2f)Multiple_Subplots_with_One_Axis_Label_attachments/Same_ylabel_subplots.png).
)# 
# <codecell>
...
# 
# yyl.set\_position((yyl.get\_position()[0],1)) \# This says use the top
# of the bottom axis as the reference point.
# 
