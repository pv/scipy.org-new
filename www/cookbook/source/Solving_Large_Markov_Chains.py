...
# <![](files/Solving_Large_Markov_Chains_attachments/tandemqueue.py>
)# 
# <codecell>
...
# Here is the result:
# 
# ` `[`![](files/Solving_Large_Markov_Chains_attachments/pi.png`](![](files/Solving_Large_Markov_Chains_attachments/pi.png)
)# 
