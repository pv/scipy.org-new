...
# ![](files/Matplotlib(2f)Gridding_irregularly_spaced_data_attachments/griddataexample1.png
# 
# Example 2
# ---------
# 
...
# The) binned data: ![](files/Matplotlib(2f)Gridding_irregularly_spaced_data_attachments/bin_small.png
# 
# Raw) data superimposed on top of binned data: ![](files/Matplotlib(2f)Gridding_irregularly_spaced_data_attachments/raw_small.png
# 
# * * * * *
# 
