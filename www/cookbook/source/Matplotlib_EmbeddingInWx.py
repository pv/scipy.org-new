...
# the
# [embedding\_in\_wx\*.py](http://cvs.sourceforge.net/viewcvs.py/matplotlib/matplotlib/examples/)
...
# [wxcursor\_demo.py](http://cvs.sourceforge.net/viewcvs.py/%2Acheckout%2A/matplotlib/matplotlib/examples/wxcursor_demo.py?content-type=text%2Fplain)
...
# 
# `1. Matt Newville's `[`MPlot`](http://cars9.uchicago.edu/~newville/Python/MPlot/)` package supports drawing 2D line plots using pylab-style `` and `` methods.`
# 
# `2. Ken !McIvor's `[`WxMpl`](http://agni.phys.iit.edu/~kmcivor/wxmpl/)` module supports drawing all plot types using matplotlib's object-oriented API.`
# 
