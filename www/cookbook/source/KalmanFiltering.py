...
# 
# ![](files/KalmanFiltering_attachments/estimate_vs_iteration.png) **Estimate vs. iteration step**
# 
# ![](files/KalmanFiltering_attachments/error_vs_iteration.png) **Estimated *a priori* error vs.
# iteration step**
# 
# <codecell>
