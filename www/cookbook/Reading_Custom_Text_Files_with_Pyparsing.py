...
# [ConfigNumParser](![](files/Reading_Custom_Text_Files_with_Pyparsing_attachments/ConfigNumParser_v0.1.1.py):
)# 
# <codecell>
...
# [ConfigNumParser](![](files/Reading_Custom_Text_Files_with_Pyparsing_attachments/ConfigNumParser_v0.1.1.py), used to parse
...
# defined in [ConfigNumParser](![](files/Reading_Custom_Text_Files_with_Pyparsing_attachments/ConfigNumParser_v0.1.1.py).
)# 
...
# \`parseFile\`. See
# [ConfigNumParser](![](files/Reading_Custom_Text_Files_with_Pyparsing_attachments/ConfigNumParser_v0.1.1.py) for more
)# information.
# 
